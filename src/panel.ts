...
function getHtml(theme = "auto"): string {
  ...
  return [
    ...
    '<div id="queuebar"></div>',
    '<div id="statusline"><span id="status"></span><span id="usage"></span></div>',
    '<div id="composer">',
    '<div id="suggest"></div>',
    '<div id="plusmenu">',
...
function css(): string {
  return [
    ...
    ".tb-btn { cursor: pointer; padding: 0 8px; height: 24px; display: inline-flex; align-items: center; border-radius: 5px; font-size: 12px; opacity: .8; white-space: nowrap; }",
    ...
    ".tb-spacer { flex: 1; }",
    "#send, #stop { border: none; border-radius: 6px; padding: 0 10px; height: 24px; cursor: pointer; font-size: 13px; background: var(--vscode-button-background); color: var(--vscode-button-foreground); display: inline-flex; align-items: center; justify-content: center; }",
    ...
    "#statusline #usage { margin-left: auto; white-space: nowrap; font-variant-numeric: tabular-nums; opacity: .8; }",
