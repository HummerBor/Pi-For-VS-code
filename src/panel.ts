...
function css(): string {
  return [
    ...
    "#hdr-row2 { margin-top: 4px; font-size: 11px; opacity: .55; display: flex; align-items: center; }",
    "#hdr-row2 #usage { margin-left: auto; font-size: 11px; opacity: .85; white-space: nowrap; font-variant-numeric: tabular-nums; }",
    ...
    "",
    "/* ── 底部状态栏 ── */",
    "#usage { font-size: 11px; opacity: .75; margin-right: 4px; white-space: nowrap; font-variant-numeric: tabular-nums; }",
    ".working-row { padding: 6px 14px; font-size: 13px; font-weight: 600; color: var(--vscode-textLink-foreground, #4daafc); animation: wpulse 1.2s ease-in-out infinite; }",
